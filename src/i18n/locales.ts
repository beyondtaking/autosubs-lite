...
export const locales = {
  zh: {
    ...
    llmApiKey: 'API Key',
    llmModel: '模型名称',
    llmFetchModels: '获取模型列表',
    llmFetchingModels: '正在获取模型列表…',
    llmModelsLoaded: (n: number) => `获取到 ${n} 个模型`,
    llmModelsFilter: '输入或点击选择模型',
    llmModelsEmpty: '无匹配模型',
    llmTest: '连接测试',
    llmTesting: '测试中…',
  ...
  en: {
    ...
    llmApiKey: 'API Key',
    llmModel: 'Model name',
    llmFetchModels: 'Fetch model list',
    llmFetchingModels: 'Fetching model list…',
    llmModelsLoaded: (n: number) => `${n} models found`,
    llmModelsFilter: 'Type or click to pick a model',
    llmModelsEmpty: 'No matching models',
